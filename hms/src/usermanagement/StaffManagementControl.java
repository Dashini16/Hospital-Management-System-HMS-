...
public class StaffManagementControl {
    ...
    public void addDoctor(Scanner scanner) {
        ...
        try {
            data.appendStaff("hms\\src\\data\\Staff_List.csv", newDoctor); // Append to CSV
        } catch (IOException e) {
    ...
    public void addPharmacist(Scanner scanner) {
        ...
        try {
            data.appendStaff("hms\\src\\data\\Staff_List.csv", newPharmacist); // Append to CSV
        } catch (IOException e) {
    ...
    public void addAdministrator(Scanner scanner) {
        ...
        try {
            data.appendStaff("hms\\src\\data\\Staff_List.csv", newAdmin); // Append to CSV
        } catch (IOException e) {
